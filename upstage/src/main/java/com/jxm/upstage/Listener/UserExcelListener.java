package com.jxm.upstage.Listener;
...
public class UserExcelListener extends AnalysisEventListener<ExcelUser> {
    ...
    //缓存
    List<ExcelUser> linkUserList = new ArrayList<>();

    int currentRow;

    Class clazz= Class.forName("com.jxm.upstage.dto.ExcelUser");

    public UserExcelListener() throws ClassNotFoundException {
        super();
    }
