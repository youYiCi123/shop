...
import com.jxm.file.entity.RPanFileChunk;
import com.jxm.file.mapper.RPanFileMapper;
import com.jxm.file.service.IErrorLogService;
import com.jxm.file.service.IFileChunkService;
...
public class FileServiceImpl implements IFileService {
    ...
    private RPanFile assembleRPanFile(String filePath, Long userId, String identifier, Long totalSize, String suffix) {
        ...
        rPanFile.setFileId(new UniqueIdGenerator(1,1).nextId());
    ...
    private String doMergeChunks(String identifier, Long userId) {
        ...
        Asserts.fail("为查询到分片信息，合并失败");
        return "为查询到分片信息，合并失败";
    }
